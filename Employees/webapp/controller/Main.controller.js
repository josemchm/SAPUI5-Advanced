                    ...
                    function(channelId, eventId, data){
                                                                        ...
                                                                        "',EmployeeId='" + data.EmployeeId + "')",
                        {
                            success: function () {
                                ...
                                sap.m.MessageToast.show(oResouceBundle.getText("odataDeleteOK"));
                            }.bind(this),
                            error: function (e) {
                                sap.m.MessageToast.show(oResouceBundle.getText("odataDeleteKO"));
                            }.bind(this)
                        });
                ...
                if(typeof incidenceModel[data.incidenceRow].IncidenceId == 'undefined'){
                    ...
                    this.getView().getModel("incidenceModel").create("/IncidentsSet", body, {
                        success: function () {
                            ...
                            MessageBox.success(oResouceBundle.getText("odataSaveOK")); 
                        }.bind(this),
                        error: function (e) {
                    ...
                    //(IncidenceId='0001',SapId='josemchm@gmail.com',EmployeeId='001')",                    
                    this.getView().getModel("incidenceModel").update("/IncidentsSet(IncidenceId='" + incidenceModel[data.incidenceRow].IncidenceId +
                        ...
                        success: function () {
                            this.onReadODataIncidence.bind(this)(employeeId);
                            sap.m.MessageToast.show(oResouceBundle.getText("odataUpdateOK"));
                        }.bind(this),
                        error: function (e) {
                            sap.m.MessageToast.show(oResouceBundle.getText("odataUpdateKO"));
                        }.bind(this)
                    });

                }else{
                    sap.m.MessageToast.show(oResouceBundle.getText("odataNoChanges"));
                }
            },
